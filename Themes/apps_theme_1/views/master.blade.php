...
@endphp
    ...
    <script>
        ...
        fbq('init', '{{ $portal->facebook_pixel }}');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id={{ $portal->facebook_pixel }}&ev=PageView&noscript=1"
        /></noscript>
    ...
    <title>@yield('title', $navbar['content']['title'] )</title>
