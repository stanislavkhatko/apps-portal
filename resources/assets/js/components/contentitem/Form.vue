            ...
            <div class="panel-body">
                <div class="form-horizontal margin_top_20">
                    ...
                    <div class="form-group">                       
                        ...
                        <div class="col-sm-4">
                            <input type="text" autocomplete="off" class="form-control" v-model="contentItem.provider" disabled>
                        </div>           
                        <template v-if="contentItem.created_at">
                            <label class="col-sm-1 control-label">Created</label>          
                            <div class="col-sm-2">
                                <input type="text" autocomplete="off" class="form-control" v-model="contentItem.created_at" disabled>
                            </div>
                            <label class="col-sm-1 control-label">Updated</label>
                            <div class="col-sm-2">
                                <input type="text" autocomplete="off" class="form-control" v-model="contentItem.updated_at" disabled>
                            </div>
                        </template>                        
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <template v-else>
                                <input v-if="!contentType" type="text" class="form-control" value="Select a content type to see categories" disabled> 
                                <input v-if="contentType" type="text" class="form-control" value="No categories available, create a new category first." disabled> 
                            </template>
                    ...
                    <div class="form-group" v-if="contentItem.compatibility && contentItem.compatibility[0].os == 'Android'">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" placeholder="Type a min. version e.g. 4.0.1" v-model="contentItem.compatibility[0].minVersion"  />
                        </div>
                    </div>
                    ...
                    <template v-if="contentTypeId && contentItem.category_id">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div href="#" class="btn btn-primary" :class="contentItemHasContent ? 'pull-right' : ''" @click="helpers.showNewLanguageModal = true">
                                    <i class="fa fa-plus"></i>                                
                                </div> 

                                <modal title="Select a new language" :value="helpers.showNewLanguageModal" @cancel="helpers.showNewLanguageModal = false" :backdrop=false>
                                    ...
                                    <div slot="modal-footer" class="modal-footer">
                                        <button type="button" class="btn btn-default min_width_100 pull-left" @click="helpers.showNewLanguageModal = false">Cancel</button>
                                        <button 
                                            type="button" 
                                ...
                                <ul class="nav nav-tabs width_100_minus_bttn">
                                    <li v-for="(appPerLanguage, key, idx) in contentItem.title" :class="idx == helpers.activeTab ? 'active' : ''">
                                        <a data-toggle="tab" :href="'#tab' + idx">{{ key }}</a>
                                    </li>
                                </ul>

                                <div class="tab-content" v-if="contentItemHasContent">
                                    <div class="tab-pane" v-for="(appPerLanguage, key, idx) in contentItem.title" :id="'tab' + idx" :class="idx == helpers.activeTab ? 'in active' : ''">

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Language</label>
                                            <div class="col-sm-10">
                                                <input type="text" autocomplete="off" class="form-control" v-model="findLanguageByCode(key).label" v-if="findLanguageByCode(key)" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" autocomplete="off" class="form-control" placeholder="Type a title" v-model="contentItem.title[key]">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <froala :config="froalaConfig" v-model="contentItem.description[key]"></froala>
                                            </div>
                                        </div>
                                        ...
                                        <div class="margin_top_10 pull-right">
                                            <button class="btn btn-danger min_width_100" @click="removeLanguage(key)">
                                                Remove <span v-if="findLanguageByCode(key)">{{ findLanguageByCode(key).label }}</span> language
                                            </button>
                                        </div>
                        ...
                        <template v-if="contentItem.provider == 'system'">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">  
                                    <v-select v-model="contentItem.type" :options="helpers.download.options" placeholder="Select a download type"></v-select>
                                </div>
                            </div>
                            <!-- form-group -->
                            ...
                            <div class="form-group" v-if="contentItem.type === 'upload'">
                                ...
                                <div class="col-sm-10">  
                                    ...
                                    <template v-if="contentItem.id && linkLoaded">
                                        ...
                                        <a :href="'/download/'+contentItem.id" class="file_download_link" target="_blank">
