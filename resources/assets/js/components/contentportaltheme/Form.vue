            ...
            <div class="panel-body">
                <div class="form-horizontal margin_top_20">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <v-select2 v-model="themes.selected.id" :options="themes.options" options-value="id" options-label="name" placeholder="Select a theme" class="width_100_percent"></v-select2>
                        </div>
                    </div>
                    <!-- portal name section -->
                    ...
                    <template v-if="themes.selected.id">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <tabs v-model="helpers.activeTab" nav-style="tabs" class="tabs_with_accordion" justified>
                        ...
                        <template v-if="hybrideThemeIsSelected">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <tabs v-model="helpers.activeTab2" nav-style="tabs" class="tabs_with_accordion" justified>
                                        ...
                                        <tab header="General">
                                            ...
                                            <accordion :one-at-atime="true" type="info">
                                                ...
                                                <panel header="Global style" is-open type="primary">                                                
                                                    ...
                                                    <small>(* A filled in google font has priority over the normal font family dropdown above)</small>
                                        ...
                                        <tab header="Content types">
                                            ...
                                            <accordion :one-at-atime="true" type="info">
                                                ...
                                                <panel header="Header title">    
                                                    ...
                                                    <small>(* if text color is empty, text will be transparant if a background image is used for the header)</small>
                                                ...
                                                <panel header="Header background">    
                                                    ...
                                                    <template v-for="(item, idx) in theme.components2.content_type.header.background">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">           
                                                                ...
                                                                <template v-if="theme.components2.content_type.header.background[idx].background_image">
                                                                    <img :src="'/storage/' + theme.components2.content_type.header.background[idx].background_image" class="img-responsive">
                                                                    <div class="text-center margin_top_10">
                                                                        <button class="btn btn-danger min_width_100" @click="theme.components2.content_type.header.background[idx].background_image = ''">
                                        ...
                                        <tab header="Categories">
                                            ...
                                            <accordion :one-at-atime="true" type="info">                                           
                                                ...
                                                <panel header="Categories" is-open type="primary">
                                                    ...
                                                    <small>(* If no, submenu with categories and categories view won't be displayed)</small>
                                            ...
                                            <accordion :one-at-atime="true" type="info">
                                                ...
                                                <panel header="Title" is-open type="primary"> 
                                                    ...
                                                    <small style="float:right">
                                                        <a href="http://www.cssportal.com/css3-text-shadow-generator/" target="_blank">open shadow generator/helper</a>
                                                    </small>
                                                    <div style="clear:both;"></div>
...
export default {
    ...
    computed: {
        hybrideThemeIsSelected() {
            ...
            if (_.findIndex(this.themes.options, function(option) { return option.id == me.themes.selected.id; }) >= 0) {

                var idx = _.findIndex(this.themes.options, function(option) { return option.id == me.themes.selected.id; });
    ...
    methods: {
        ...
        updateTheme(goBack) {
            ...
            axios.patch('/admin/api/portal-theme/' + this.portal.id, { selectedThemeId: this.themes.selected.id, config: this.theme, custom_css: this.custom_css })
                .then((response) => {
