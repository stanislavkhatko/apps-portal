            ...
            <div class="panel-body">
                <div class="form-horizontal margin_top_20">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" autocomplete="off" class="form-control" placeholder="Type a name for the content type (will only be used for easy recognition in backend)" v-model="contentType.name">
                        </div>
                    </div>
                    <!-- portal name section -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">  
                            ...
                            <template v-else>
                                <dropzone 
                                    id="myVueDropzone" 
                                    url="/admin/api/local-content-type/upload-icon" 
                                    :useFontAwesome="true"
                    ...
                    <template v-if="selectedLanguages.length > 0">
                        ...
                        <!-- pages modals --> 
                        <modal title="Add existing categories from providers" :backdrop=false :value="searchCategories.showModal" @cancel="searchCategories.showModal = false">
                            ...
                            <div slot="modal-footer" class="modal-footer">
                                <button type="button" class="btn btn-default min_width_100 pull-left" @click="searchCategories.showModal = false">Cancel</button>
                                <button type="button" class="btn btn-success min_width_100" :class="searchCategories.selected.length > 0 ? '' : 'disabled'" @click="addSelectedCategories">Add categories</button>
                            </div>
                        </modal>
                        <!-- end pages modals --> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div :class="contentType.local_categories.length > 0 ? 'add_bttn_absolute padding_right_0' : ''">
                                    <button class="btn btn-primary with_cursor" @click="searchCategories.showModal = true;">
                                ...
                                <div class="tab-content" v-if="contentType.local_categories.length > 0">
                                    <div :id="'s_2page' + langIdx" class="tab-pane" v-for="(language, langIdx) in selectedLanguages" :class="langIdx == 0 ? 'in active' : ''">

                                        <table class="table table-borderless m-b-none" v-if="contentType.local_categories.length > 0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 110px;">
                                                        ...
                                                        <tooltip content="Content items to be shown<br />/<br />Conten items available from provider" style="position: relative;">
                                                            <i class="fa fa-question-circle"></i>
                                                        </tooltip>
                                                    </th>
                                                    <th style="width: 124px;">
                                                        Auto sync<br />content items 
                                                        <tooltip content="Choose if new content items are automatically added to the category if a provider adds new items for the linked category" style="position: relative;">
                                                            <i class="fa fa-question-circle"></i>
                                                        </tooltip>
                                                    </th>
                                                ...
                                                <template v-for="(category, idx) in contentType.local_categories">
                                                    <tr>
                                                        ...
                                                        <td >
                                                            ...
                                                            <div class="btn btn-default" @click="showContentItemsModal(category)" v-if="category.id != 0"> 
                                                                <i class="fa fa-pencil"></i>&nbsp;&nbsp;<strong>{{ category.content_items_count }}<small>/{{ category.provider_content_items_count }}</small></strong>
                                                            </div>  

                                                            <tooltip v-if="category.id == 0" content="Save content type first to manage content items" style="position: relative;">
                                                                <button class="btn btn-default" style="opacity: 0.5;">
                                                                    <i class="fa fa-question-circle"></i>&nbsp;&nbsp;<strong>{{ category.content_items_count }}<small>/{{ category.provider_content_items_count }}</small></strong>
                                                                </button>
                                                            </tooltip> 
                                                        </td>  
                                                        <td>
                                                        ...
                                                        <td>    
                                                            ...
                                                            <br>
                                                            Category: <strong>{{ category.provider_category_label }}</strong>
                                                            <br>
                                                            Adult: <strong>{{ category.provider_category_adult == 1 ? 'Yes': 'No' }}</strong> 
                                                            <br>
                                                            Content items available: <strong>{{ category.provider_content_items_count }}</strong> 
                                                        </td>                             
                                                        <td class="text-right padding_right_0">
                                                            <div class="btn btn-danger" @click="removeCategoryFromContentType(idx)"> 
