                		        ...
                		        <div class="tab-content">
                		            <div :id="'s_page' + langIdx" class="tab-pane" v-for="(language, langIdx) in selectedLanguages" :class="langIdx == 0 ? 'in active' : ''">
                		            	...
                		            	<div class="form-group truukske" v-for="(translation, idx) in translations">
                		            	    ...
                		            	    <div class="col-sm-2">                                          
                		            	    	<input type="text" autocomplete="off" class="form-control bold" v-model="translation.key"  placeholder="Type a key" :disabled="translation.in_use == 1">
                		            	    </div>

                		            	    <div class="col-sm-10">
                		            	    	<input type="text" autocomplete="off" class="form-control width_100_minus_bttn pull-left" v-model="translation.text[language.value]"  :placeholder="language.label + ' translation for the key ' + translation.key">
                		            	    	
                                                <tooltip class="pull-right" content="This translation is marked as<br>'IN USE' and can not be deleted" style="position: relative;display:block;" v-if="translation.in_use == 1">
                                                    <div class="btn btn-danger" style="opacity: 0.2">
                                                        <i class="fa fa-times"></i>
                                                    </div>
                                                </tooltip>

                		            	    	<div class="btn btn-danger pull-right" @click="removeTranslation(idx)" v-if="translation.in_use == 0"> 
                		            	    	    <i class="fa fa-times"></i>
                		            	    	</div>
    ...
    watch: {
        'selectedLanguages': function(languages) {
            ...
            languages.forEach((language) => {
            	...
            	if (!me.translations[0].text.hasOwnProperty(language.value)) {
